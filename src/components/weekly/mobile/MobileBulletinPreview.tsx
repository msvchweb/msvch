...
import { BulletinFooterLinks, ChurchNews, NextWeekServing } from "@/components/mobile-bulletin/MobileBulletinSections";
...
export function MobileBulletinPreview({ weekly }: { weekly: WeeklyContentInput }) {
  ...
  return (
    <div className="mx-auto max-w-[430px] overflow-hidden rounded-[2rem] border-8 border-stone-900 bg-church-cream shadow-xl">
