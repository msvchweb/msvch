  ...
  return (
    <section className="relative h-[85vh] min-h-[760px] overflow-hidden bg-church-dark md:min-h-[640px]">
      ...
      <Link
        ...
        className="group absolute right-3 top-3 z-20 flex max-w-[calc(100%-1.5rem)] items-center gap-1.5 rounded-full border border-white/70 bg-white/90 px-2.5 py-1.5 text-church-dark shadow-lg shadow-black/20 backdrop-blur transition-colors duration-200 hover:bg-white md:hidden"
      >
        <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-church-gold text-church-dark">
          <BellOff size={14} />
        </span>
