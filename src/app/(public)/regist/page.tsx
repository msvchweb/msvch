...
import { Loader2, CheckCircle2, User, Phone, Calendar, Users } from "lucide-react";
      ...
      <div className="mx-auto max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-4 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-gray-100">
            ...
            <div>
              <label className="mb-2 flex items-center gap-2 text-sm font-semibold text-gray-700">
                {contactType === "phone" ? <Phone size={16} className="text-gray-400" /> : <InstagramIcon size={16} className="text-gray-400" />}
                연락처
              </label>
